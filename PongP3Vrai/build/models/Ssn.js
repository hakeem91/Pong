"use strict";
const informationFinder = require('../../../Api_SSN/app/people/helpers/informationFinder');
...
class Ssn {
    ...
    getInfo() {
        return {
            ...
            birthPlace: informationFinder.extractBirthPlace(this.secu_number),
            birthPosition: this.extractPosition(),
            birthCommune : informationFinder.extractBirthPlaceCommune(this.secu_number)
        };
    }
    /**
     *
